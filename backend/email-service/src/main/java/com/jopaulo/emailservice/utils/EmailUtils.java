package com.jopaulo.emailservice.utils;
...
public class EmailUtils {
    ...
    public static final String EMAIL = "jopaulo758@gmail.com";
    ...
    public static Context getContextToCreatedOrder(OrderCreatedMessage orderDTO) {
        ...
        context.setVariable("responsibleTechnician", orderDTO.getRequest().name());
